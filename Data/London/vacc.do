...
import excel "C:\Users\Augustin\Downloads\COVID-19-weekly-announced-vaccinations-23-September-2021.xlsx", sheet("MSOA") cellrange(A12:BK6817) firstrow clear
drop AJ
drop AL-BK
ren AK total
drop A
...
*
forvalues i=60/94 {
append using "C:\Users\Augustin\OneDrive - King's College London\adc\ArcScott\data\msoavac_w`i'.dta"
}
g bcode2=substr(LTLAcode,1,3)
keep if bcode2=="E09"

destring fd_18_24, replace ignore("*")
destring fd_Under18, replace ignore("*")



egen 
egen fdtotal=if week>67

save "C:\Users\Augustin\Downloads\vax59-94.dta", replace
save "C:\Users\Augustin\Documents\GitHub\covid19\Data\London\vax59-94.dta",replace
